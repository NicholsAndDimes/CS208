...
<<< This is the complex bug 'clever_lichterman' (instance 7 of 9) >>>
<<< This is the complex bug 'clever_lichterman' (instance 8 of 9) >>>
<<< This is the complex bug 'clever_lichterman' (instance 9 of 9) >>>
        }
        finally
        {
            if (in != null)
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        {
            if (qName.equals(ELEMENT_PROPERTY))
            {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException
    {
        ...
        else
        {
            ...
            {
                if (qName.equals(ELEMENT_LOGIN))
                {
                    login = characters.toString().trim();
                }
                else
                {
                    if (qName.equals(ELEMENT_PASSWORD))
                    {
