...
class BookmarkOutputStream extends ByteArrayOutputStream implements BookmarkBuilder
{
    ...
    public void close() throws IOException
    {
        ...
        {
<<< This is the complex bug 'peaceful_goodall' (instance 1 of 9) >>>
<<< This is the complex bug 'peaceful_goodall' (instance 2 of 9) >>>
<<< This is the complex bug 'peaceful_goodall' (instance 3 of 9) >>>
            throw e;
        }
        catch (Exception e)
        {
