...
public class GlobalLocationHistory implements LocationListener
{
    ...
    private GlobalLocationHistory()
    {
        ...
        for (int i = 0; i < nbLocations; ++i)
        {
            ...
            try
            {
<<< This is the complex bug 'charismatic_archimedes' (instance 7 of 9) >>>
<<< This is the complex bug 'charismatic_archimedes' (instance 8 of 9) >>>
<<< This is the complex bug 'charismatic_archimedes' (instance 9 of 9) >>>
