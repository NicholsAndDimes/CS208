...
class CommandOpen extends LocalFileOperation
{
    ...
    {
        if (allowDefault)
<<< This is the complex bug 'enchanted_lewin' (instance 7 of 9) >>>
<<< This is the complex bug 'enchanted_lewin' (instance 8 of 9) >>>
<<< This is the complex bug 'enchanted_lewin' (instance 9 of 9) >>>
        {
            return true;
        }
