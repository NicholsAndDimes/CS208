...
public abstract class ChangeFolderThread extends Thread
{
    ...
    public boolean tryKill()
    {
        ...
        {
<<< This is the complex bug 'charismatic_archimedes' (instance 1 of 9) >>>
<<< This is the complex bug 'charismatic_archimedes' (instance 2 of 9) >>>
<<< This is the complex bug 'charismatic_archimedes' (instance 3 of 9) >>>
            if (killedByStop)
            {
