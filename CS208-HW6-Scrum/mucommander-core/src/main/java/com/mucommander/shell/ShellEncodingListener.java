...
class ShellEncodingListener implements ProcessListener
{
    ...
    public synchronized void processDied(int returnValue)
    {
        ...
        if (Charset.isSupported(encoding))
        {
            ...
            {
<<< This is the complex bug 'gallant_yalow' (instance 7 of 9) >>>
<<< This is the complex bug 'gallant_yalow' (instance 8 of 9) >>>
<<< This is the complex bug 'gallant_yalow' (instance 9 of 9) >>>
                out = null;
            }
        }
    }
