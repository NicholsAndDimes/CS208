...
class ShellHistoryReader extends DefaultHandler implements ShellHistoryConstants
{
    ...
    {
<<< This is the medium bug 'eager_sammet' (instance 1 of 4) >>>
<<< This is the medium bug 'eager_sammet' (instance 2 of 4) >>>
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        {
            if (qName.equals(COMMAND_ELEMENT) && status == STATUS_ROOT)
            {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException
    {
        ...
        {
            if (qName.equals(COMMAND_ELEMENT) && (status == STATUS_COMMAND))
            {
                status = STATUS_ROOT;
