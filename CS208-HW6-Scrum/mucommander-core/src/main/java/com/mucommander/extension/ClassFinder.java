    ...
    private List<Class<?>> find(String currentPackage, AbstractFile currentFile) throws IOException
    {
        ...
        for (AbstractFile file : files)
        {
            ...
            else
            {
                ...
                {
<<< This is the complex bug 'cranky_rosalind' (instance 7 of 9) >>>
<<< This is the complex bug 'cranky_rosalind' (instance 8 of 9) >>>
<<< This is the complex bug 'cranky_rosalind' (instance 9 of 9) >>>
                }
            }
        }
        return result;
