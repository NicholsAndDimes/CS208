...
<<< This is the complex bug 'romantic_mcnulty' (instance 4 of 9) >>>
<<< This is the complex bug 'romantic_mcnulty' (instance 5 of 9) >>>
<<< This is the complex bug 'romantic_mcnulty' (instance 6 of 9) >>>
    ...
    private void run()
    {
        try
        {
            ...
            if (preferences != null)
            {
                ...
                {
                    printError("Could not set preferences folder", e, activator.fatalWarnings());
                }
            }
