...
<<< This is the medium bug 'eager_sammet' (instance 3 of 4) >>>
<<< This is the medium bug 'eager_sammet' (instance 4 of 4) >>>
...
public class MuSnapshot
{
    ...
    private void setTableAttributes(int index, boolean isLeft, FileTable table)
    {
        ...
        {
            if (c != Column.NAME)
            {       // Skip the special name column (always enabled, width automatically calculated)
