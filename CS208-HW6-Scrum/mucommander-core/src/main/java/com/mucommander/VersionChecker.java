...
<<< This is the medium bug 'friendly_lalande' (instance 3 of 4) >>>
<<< This is the medium bug 'friendly_lalande' (instance 4 of 4) >>>
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        {
            if (qName.equals(DOWNLOAD_URL_ELEMENT))
            {
                state = STATE_DOWNLOAD_URL;
            }
            else
            {
                if (qName.equals(JAR_URL_ELEMENT))
                {
                    state = STATE_JAR_URL;
                }
                else
