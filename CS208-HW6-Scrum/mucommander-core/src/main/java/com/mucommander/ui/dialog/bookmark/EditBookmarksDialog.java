...
<<< This is the complex bug 'stoic_leavitt' (instance 1 of 9) >>>
<<< This is the complex bug 'stoic_leavitt' (instance 2 of 9) >>>
<<< This is the complex bug 'stoic_leavitt' (instance 3 of 9) >>>
...
public class EditBookmarksDialog extends FocusDialog implements ActionListener, ListSelectionListener, DocumentListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            if (source == newButton || source == duplicateButton)
            {
