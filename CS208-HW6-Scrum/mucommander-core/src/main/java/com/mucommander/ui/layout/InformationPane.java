    ...
    public void setIcon(Icon icon)
    {
        if (icon == null)
        {
            if (iconLabel != null)
            {
                remove(iconLabel);
                iconLabel = null;
<<< This is the complex bug 'condescending_khayyam' (instance 4 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 5 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 6 of 9) >>>
            }
        }
        else
        {
