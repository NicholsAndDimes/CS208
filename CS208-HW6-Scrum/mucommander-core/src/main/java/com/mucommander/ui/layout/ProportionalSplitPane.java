...
<<< This is the complex bug 'condescending_khayyam' (instance 7 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 8 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 9 of 9) >>>
        }
    ...
    public void componentMoved(ComponentEvent e)
    {
        if (e.getSource() == getDividerComponent())
        {
            ...
            {
                if (lastDividerLocation == getDividerLocation())
                {
                    return;
                }
            }
