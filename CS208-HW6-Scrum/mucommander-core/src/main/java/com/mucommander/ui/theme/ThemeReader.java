    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if (qName.equals(ELEMENT_EDITOR))
                    {
                        if (state != STATE_ROOT)
                        {
                            traceIllegalDeclaration(qName);
                    ...
                    {
                        if (qName.equals(ELEMENT_LOCATION_BAR))
                        {
                            if (state != STATE_ROOT)
                            {
                                traceIllegalDeclaration(qName);
                        ...
                        {
                            if (qName.equals(ELEMENT_QUICK_LIST))
                            {
                                if (state != STATE_ROOT)
                                {
                                    traceIllegalDeclaration(qName);
                            ...
                            {
                                if (qName.equals(ELEMENT_SHELL_HISTORY))
                                {
                                    if (state != STATE_ROOT)
                                    {
                                        traceIllegalDeclaration(qName);
                                ...
                                {
                                    if (qName.equals(ELEMENT_STATUS_BAR))
                                    {
                                        if (state != STATE_ROOT)
                                        {
                                            traceIllegalDeclaration(qName);
                                    ...
                                    {
                                        if (qName.equals(ELEMENT_HIDDEN))
                                        {
                                        ...
                                        {
                                            if (qName.equals(ELEMENT_FOLDER))
                                            {
                                                if (state != STATE_TABLE)
                                                {
                                                    traceIllegalDeclaration(qName);
                                            ...
                                            {
                                                if (qName.equals(ELEMENT_ARCHIVE))
                                                {
                                                    if (state != STATE_TABLE)
                                                    {
                                                        traceIllegalDeclaration(qName);
                                                ...
                                                {
                                                    if (qName.equals(ELEMENT_SYMLINK))
                                                    {
                                                        if (state != STATE_TABLE)
                                                        {
                                                            traceIllegalDeclaration(qName);
                                                    ...
                                                    {
                                                        if (qName.equals(ELEMENT_MARKED))
                                                        {
                                                            if (state != STATE_TABLE)
                                                            {
                                                                traceIllegalDeclaration(qName);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                if (qName.equals(ELEMENT_ALTERNATE))
                                                                {
                                                                    if (state != STATE_TABLE)
                                                                    {
                                                                        traceIllegalDeclaration(qName);
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            {
                                                                                if (qName.equals(ELEMENT_SELECTED))
                                                                                {
                                                                                    if (state == STATE_SHELL)
                                                                                    {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        if (qName.equals(ELEMENT_INACTIVE_BACKGROUND))
                                                                                        {
                                                                                        ...
                                                                                        {
                                                                                            if (qName.equals(ELEMENT_SECONDARY_BACKGROUND))
                                                                                            {
                                                                                                if (state == STATE_TABLE_SELECTED)
                                                                                                {
                                                                                            ...
                                                                                            {
                                                                                                if (qName.equals(ELEMENT_INACTIVE_SECONDARY_BACKGROUND))
                                                                                                {
                                                                                                    if (state == STATE_TABLE_SELECTED)
                                                                                                    {
                                                                                                ...
                                                                                                {
                                                                                                    if (qName.equals(ELEMENT_INACTIVE_FOREGROUND))
                                                                                                    {
                                                                                                    ...
                                                                                                    {
                                                                                                        if (qName.equals(ELEMENT_BORDER))
                                                                                                        {
                                                                                                            if (state == STATE_TABLE)
                                                                                                            {
                                                                                                        ...
                                                                                                        {
                                                                                                            if (qName.equals(ELEMENT_INACTIVE_BORDER))
                                                                                                            {
                                                                                                                if (state == STATE_TABLE)
                                                                                                                {
                                                                                                            ...
                                                                                                            else
                                                                                                            {
                                                                                                                ...
                                                                                                                {
                                                                                                                    if (qName.equals(ELEMENT_INACTIVE_OUTLINE))
                                                                                                                    {
                                                                                                                        if (state == STATE_TABLE)
                                                                                                                        {
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        if (qName.equals(ELEMENT_UNMATCHED))
                                                                                                                        {
                                                                                                                            if (state != STATE_TABLE)
                                                                                                                            {
                                                                                                                                traceIllegalDeclaration(qName);
                                                                                                                        ...
                                                                                                                        {
                                                                                                                            if (qName.equals(ELEMENT_BACKGROUND))
                                                                                                                            {
                                                                                                                                if (state == STATE_TABLE_NORMAL)
                                                                                                                                {
                                                                                                                            ...
                                                                                                                            {
                                                                                                                                if (qName.equals(ELEMENT_PROGRESS))
                                                                                                                                {
                                                                                                                                    if (state == STATE_LOCATION_BAR)
                                                                                                                                    {
                                                                                                                                ...
                                                                                                                                else
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    {
                                                                                                                                        if (qName.equals(ELEMENT_WARNING))
                                                                                                                                        {
                                                                                                                                            if (state == STATE_STATUS_BAR)
                                                                                                                                            {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if (qName.equals(ELEMENT_CRITICAL))
                                                                                                                                            {
                                                                                                                                                if (state == STATE_STATUS_BAR)
                                                                                                                                                {
                                                                                                                                            ...
                                                                                                                                            {
                                                                                                                                                if (qName.equals(ELEMENT_FOREGROUND))
                                                                                                                                                {
                                                                                                                                                    if (state == STATE_HIDDEN_NORMAL)
                                                                                                                                                    {
