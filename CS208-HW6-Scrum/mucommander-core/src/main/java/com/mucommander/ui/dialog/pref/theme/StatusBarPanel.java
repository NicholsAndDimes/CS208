...
<<< This is the complex bug 'friendly_aryabhata' (instance 7 of 9) >>>
<<< This is the complex bug 'friendly_aryabhata' (instance 8 of 9) >>>
<<< This is the complex bug 'friendly_aryabhata' (instance 9 of 9) >>>
...
class StatusBarPanel extends ThemeEditorPanel implements PropertyChangeListener
{
    ...
    public void propertyChange(PropertyChangeEvent event)
    {
        ...
        {
            if (event.getPropertyName().equals(PreviewLabel.FOREGROUND_COLOR_PROPERTY_NAME))
            {
                Color color;
            ...
            {
                if (event.getPropertyName().equals(PreviewLabel.BORDER_COLOR_PROPERTY_NAME))
                {
