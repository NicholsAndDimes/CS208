...
public abstract class AbstractActionDescriptor implements ActionDescriptor
{
    ...
    public String getDescription()
    {
        ...
        if (tooltip == null)
<<< This is the complex bug 'elastic_khayyam' (instance 1 of 9) >>>
<<< This is the complex bug 'elastic_khayyam' (instance 2 of 9) >>>
<<< This is the complex bug 'elastic_khayyam' (instance 3 of 9) >>>
        {
            return getLabel();
        }
        return tooltip;
