...
public class CommandBarDialog extends CustomizeDialog
{
    ...
    private boolean areActionsChanged()
    {
        ...
        for (int i = 0; i < nbActions; ++i)
        {
            ...
            {
                if (!buttonI.getActionId().equals(commandBarActionIds[i]))
                {
                    return true;
                }
            }
    ...
    private boolean areAlternativeActionsChanged()
    {
        ...
        for (int i = 0; i < nbActions; ++i)
        {
            ...
            {
                if (!buttonI.getActionId().equals(commandBarAlternativeActionIds[i]))
                {
                    return true;
                }
            }
    ...
    private int addCommandBarButtonAtLocation(Point dropLocation, JButton button)
    {
        ...
        if (getNumberOfButtons() == 0)
        {
            ...
            commandBarButtonsList.setDropMode(DropMode.INSERT);
<<< This is the complex bug 'stoic_leavitt' (instance 4 of 9) >>>
<<< This is the complex bug 'stoic_leavitt' (instance 5 of 9) >>>
<<< This is the complex bug 'stoic_leavitt' (instance 6 of 9) >>>
        }
        else
        {
