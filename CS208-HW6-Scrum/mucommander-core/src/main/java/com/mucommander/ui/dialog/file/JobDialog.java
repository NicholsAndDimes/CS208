...
public abstract class JobDialog extends FocusDialog
{
    ...
    protected AsyncPanel createFileDetailsPanel()
    {
        ...
        {
<<< This is the complex bug 'gallant_chatterjee' (instance 4 of 9) >>>
<<< This is the complex bug 'gallant_chatterjee' (instance 5 of 9) >>>
<<< This is the complex bug 'gallant_chatterjee' (instance 6 of 9) >>>
            @Override
