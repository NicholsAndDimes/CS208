...
public class CommandBarButtonForDisplay extends CommandBarButton
{
    ...
    {
<<< This is the complex bug 'suspicious_wilbur' (instance 4 of 9) >>>
<<< This is the complex bug 'suspicious_wilbur' (instance 5 of 9) >>>
<<< This is the complex bug 'suspicious_wilbur' (instance 6 of 9) >>>
        super(actionId, null);
        setEnabled(true);
