...
public abstract class AsyncPanel extends JPanel
{
    ...
    {
        new Thread()
<<< This is the complex bug 'condescending_khayyam' (instance 1 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 2 of 9) >>>
<<< This is the complex bug 'condescending_khayyam' (instance 3 of 9) >>>
        {
            @Override
            public void run()
            {
