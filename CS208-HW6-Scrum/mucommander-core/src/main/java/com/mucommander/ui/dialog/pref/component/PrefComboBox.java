...
public abstract class PrefComboBox<T> extends JComboBox<T> implements PrefComponent
{
    ...
    public void addDialogListener(final PreferencesDialog dialog)
    {
        addItemListener(new ItemListener()
        {
            ...
            {
<<< This is the complex bug 'expressive_haslett' (instance 4 of 9) >>>
<<< This is the complex bug 'expressive_haslett' (instance 5 of 9) >>>
<<< This is the complex bug 'expressive_haslett' (instance 6 of 9) >>>
