...
public class QuickListHeaderItem extends QuickListItem
{
    ...
    {
        super(text);
<<< This is the complex bug 'sarcastic_mccarthy' (instance 7 of 9) >>>
<<< This is the complex bug 'sarcastic_mccarthy' (instance 8 of 9) >>>
<<< This is the complex bug 'sarcastic_mccarthy' (instance 9 of 9) >>>
    ...
    public void colorChanged(ColorChangedEvent event)
    {
        ...
        {
            if (event.getColorId() == ThemeData.QUICK_LIST_HEADER_FOREGROUND_COLOR)
            {
            ...
            {
                if (event.getColorId() == ThemeData.QUICK_LIST_HEADER_SECONDARY_BACKGROUND_COLOR)
                {
