...
<<< This is the medium bug 'humorous_moore' (instance 3 of 4) >>>
<<< This is the medium bug 'humorous_moore' (instance 4 of 4) >>>
        {
    ...
    public Object getTransferData(DataFlavor dataFlavor) throws UnsupportedFlavorException, IOException
    {
        ...
        {
            if (dataFlavor.equals(DataFlavor.javaFileListFlavor) && javaFileListFlavorSupported)
            {
...
//        }
            ...
            {
                if (dataFlavor.equals(DataFlavor.stringFlavor) && stringFlavorSupported)
                {
                    StringBuilder sb = new StringBuilder();
                    AbstractFile file;
                    for (int i = 0; i < nbFiles; i++)
                ...
                {
                    if (dataFlavor.equals(TEXT_URI_FLAVOR) && textUriFlavorSupported)
                    {
                        StringBuilder sb = new StringBuilder();
                        AbstractFile file;
                        for (int i = 0; i < nbFiles; i++)
