...
<<< This is the complex bug 'sarcastic_mccarthy' (instance 1 of 9) >>>
<<< This is the complex bug 'sarcastic_mccarthy' (instance 2 of 9) >>>
<<< This is the complex bug 'sarcastic_mccarthy' (instance 3 of 9) >>>
...
public class QuickListDataList<T> extends JList
{
    ...
    protected class DataListItemRenderer extends DefaultListCellRenderer implements ThemeListener
    {
        ...
        public void colorChanged(ColorChangedEvent event)
        {
            ...
            {
                if (event.getColorId() == ThemeData.QUICK_LIST_ITEM_FOREGROUND_COLOR)
                {
                ...
                {
                    if (event.getColorId() == ThemeData.QUICK_LIST_SELECTED_ITEM_BACKGROUND_COLOR)
                    {
                    ...
                    {
                        if (event.getColorId() == ThemeData.QUICK_LIST_SELECTED_ITEM_FOREGROUND_COLOR)
                        {
