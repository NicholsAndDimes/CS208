...
<<< This is the complex bug 'musing_wiles' (instance 1 of 9) >>>
<<< This is the complex bug 'musing_wiles' (instance 2 of 9) >>>
<<< This is the complex bug 'musing_wiles' (instance 3 of 9) >>>
        else
        {
            if ((modifiers & KeyEvent.META_DOWN_MASK) != 0)
            {
