...
<<< This is the medium bug 'admiring_jang' (instance 3 of 4) >>>
<<< This is the medium bug 'admiring_jang' (instance 4 of 4) >>>
...
class LocationBarPanel extends ThemeEditorPanel implements PropertyChangeListener
{
    ...
    public void propertyChange(PropertyChangeEvent event)
    {
        ...
        else
        {
            ...
            {
                if (event.getPropertyName().equals(PreviewLabel.OVERLAY_COLOR_PROPERTY_NAME))
                {
                    setProgressColors();
                }
            }
