...
public abstract class PrefTable extends JTable implements PrefComponent
{
    ...
    public void addDialogListener(final PreferencesDialog dialog)
    {
        ...
        {
<<< This is the complex bug 'expressive_haslett' (instance 7 of 9) >>>
<<< This is the complex bug 'expressive_haslett' (instance 8 of 9) >>>
<<< This is the complex bug 'expressive_haslett' (instance 9 of 9) >>>
