...
public class DownloadDialog extends TransferDestinationDialog
{
    ...
    protected TransferFileJob createTransferFileJob(ProgressDialog progressDialog, PathUtils.ResolvedDestination resolvedDest, int defaultFileExistsAction)
    {
        return new CopyJob(
                progressDialog,
<<< This is the complex bug 'dazzling_elbakyan' (instance 7 of 9) >>>
<<< This is the complex bug 'dazzling_elbakyan' (instance 8 of 9) >>>
<<< This is the complex bug 'dazzling_elbakyan' (instance 9 of 9) >>>
                mainFrame,
                files,
