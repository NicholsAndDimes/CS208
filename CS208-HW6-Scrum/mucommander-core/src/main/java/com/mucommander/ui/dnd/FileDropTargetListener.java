...
<<< This is the medium bug 'humorous_moore' (instance 1 of 4) >>>
<<< This is the medium bug 'humorous_moore' (instance 2 of 4) >>>
...
public class FileDropTargetListener implements DropTargetListener
{
     ...
     * @param changeFolderOnlyMode if <code>true</code>, the FolderPanel's current folder can only be changed when file(s) are dropped,
