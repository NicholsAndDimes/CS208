...
public class CombineFilesJob extends AbstractCopyJob
{
    ...
    private void findCRCFile(AbstractFile file)
    {
        ...
        if (f != null)
        {
            try
            {
<<< This is the complex bug 'elastic_shirley' (instance 7 of 9) >>>
<<< This is the complex bug 'elastic_shirley' (instance 8 of 9) >>>
<<< This is the complex bug 'elastic_shirley' (instance 9 of 9) >>>
