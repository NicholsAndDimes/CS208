...
public interface FileJobAction
{
    ...
    int SKIP = 0;
    int SKIP_ALL = 1;
<<< This is the complex bug 'condescending_swanson' (instance 1 of 9) >>>
<<< This is the complex bug 'condescending_swanson' (instance 2 of 9) >>>
<<< This is the complex bug 'condescending_swanson' (instance 3 of 9) >>>
    int RETRY = 2;
    int CANCEL = 3;
    int APPEND = 4;
    int OK = 5;
