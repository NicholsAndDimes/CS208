...
public class JobsManager implements FileJobListener
{
    ...
    public void jobExecutionModeChanged(FileJob source, boolean background)
    {
        if (background)
        {
<<< This is the complex bug 'condescending_swanson' (instance 7 of 9) >>>
<<< This is the complex bug 'condescending_swanson' (instance 8 of 9) >>>
<<< This is the complex bug 'condescending_swanson' (instance 9 of 9) >>>
            fireJobAdded(source);
        }
        else
        {
