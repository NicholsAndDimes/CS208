...
<<< This is the easy bug 'quirky_ardinghelli' (instance 1 of 1) >>>
    ...
    protected AbstractFile checkForCollision(AbstractFile file, AbstractFile destFolder, AbstractFile destFile, boolean allowCaseVariation)
    {
        ...
        while (true)
        {
            ...
            if (collision != FileCollisionChecker.NO_COLLOSION)
            {
                ...
                {
                    if (choice == FileCollisionDialog.SKIP_ACTION)
                    {
                        return null;
                    }
                    ...
                    {
                        if (choice == FileCollisionDialog.RESUME_ACTION)
                        {
                            append = true;
                            break;
                        }
                        ...
                        else
                        {
                            ...
                            {
                                if (choice == FileCollisionDialog.OVERWRITE_IF_OLDER_ACTION)
                                {
                                ...
                                {
                                    if (choice == FileCollisionDialog.RENAME_ACTION)
                                    {
                                        setPaused(true);
