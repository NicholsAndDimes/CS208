...
<<< This is the medium bug 'stupefied_roentgen' (instance 3 of 4) >>>
<<< This is the medium bug 'stupefied_roentgen' (instance 4 of 4) >>>
...
//        jobThread.interrupt();
    ...
    public void setPaused(boolean paused)
    {
        ...
        synchronized (pauseLock)
        {
            ...
            {
                if (paused && getState() != FileJobState.PAUSED && getState() != FileJobState.INTERRUPTED && getState() != FileJobState.FINISHED)
                {
