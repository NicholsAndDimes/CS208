...
<<< This is the complex bug 'peculiar_galileo' (instance 4 of 9) >>>
<<< This is the complex bug 'peculiar_galileo' (instance 5 of 9) >>>
<<< This is the complex bug 'peculiar_galileo' (instance 6 of 9) >>>
...
public class TempOpenWithJob extends TempCopyJob
{
    ...
    protected boolean processFile(AbstractFile file, Object recurseParams)
    {
        ...
        {
            if (!currentDestFile.isDirectory())
            {        // Do not change directories' permissions
                try
                {
