...
//             In this way buffered streams will cascade harmlessly. */
    ...
    {
        if (buffer != null)
        {      // buffer is null if close() was already called
<<< This is the complex bug 'ironic_noether' (instance 1 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 2 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 3 of 9) >>>
            try
            {
                flush();
            }
