...
public class FilteredRandomOutputStream extends RandomAccessOutputStream
{
    ...
    {
        try
<<< This is the complex bug 'vigilant_lichterman' (instance 7 of 9) >>>
<<< This is the complex bug 'vigilant_lichterman' (instance 8 of 9) >>>
<<< This is the complex bug 'vigilant_lichterman' (instance 9 of 9) >>>
        {
            flush();
        }
        catch (IOException e)
