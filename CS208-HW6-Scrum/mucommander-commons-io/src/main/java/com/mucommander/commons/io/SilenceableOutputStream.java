...
public class SilenceableOutputStream extends FilterOutputStream
{
    ...
    {
<<< This is the complex bug 'elastic_galileo' (instance 1 of 9) >>>
<<< This is the complex bug 'elastic_galileo' (instance 2 of 9) >>>
<<< This is the complex bug 'elastic_galileo' (instance 3 of 9) >>>
        if (silenced)
        {
            return;
        }
