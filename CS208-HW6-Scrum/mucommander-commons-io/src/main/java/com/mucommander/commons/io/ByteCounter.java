...
public class ByteCounter
{
    ...
    public synchronized void add(ByteCounter counter, boolean resetAfter)
    {
        ...
        synchronized (counter)
        {
            ...
            if (resetAfter)
<<< This is the complex bug 'ironic_noether' (instance 7 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 8 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 9 of 9) >>>
            {
                counter.reset();
            }
        }
