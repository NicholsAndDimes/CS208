...
public class BufferPool
{
    ...
    public static int getBufferCount(BufferFactory factory)
    {
        ...
        int nbBuffers = bufferContainers.size();
        for (int i = 0; i < nbBuffers; i++)
<<< This is the complex bug 'ironic_noether' (instance 4 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 5 of 9) >>>
<<< This is the complex bug 'ironic_noether' (instance 6 of 9) >>>
        {
