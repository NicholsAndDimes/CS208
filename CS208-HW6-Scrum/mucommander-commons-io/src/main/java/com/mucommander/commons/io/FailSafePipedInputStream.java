...
public class FailSafePipedInputStream extends PipedInputStream
{
    ...
    {
        if (failure != null)
<<< This is the complex bug 'vigilant_lichterman' (instance 4 of 9) >>>
<<< This is the complex bug 'vigilant_lichterman' (instance 5 of 9) >>>
<<< This is the complex bug 'vigilant_lichterman' (instance 6 of 9) >>>
        {
            throw failure;
        }
    }
