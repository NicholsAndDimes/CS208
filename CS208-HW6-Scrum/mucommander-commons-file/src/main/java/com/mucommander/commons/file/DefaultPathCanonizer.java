...
<<< This is the complex bug 'keen_swartz' (instance 1 of 9) >>>
<<< This is the complex bug 'keen_swartz' (instance 2 of 9) >>>
<<< This is the complex bug 'keen_swartz' (instance 3 of 9) >>>
            ...
            while ((pos = pos2) != -1)
            {
                ...
                else
                {
                    ...
                    {
                        if (tildeReplacement != null && dirWS.equals("~"))
                        {
