    ...
    public void parse(String url, FileURL fileURL) throws MalformedURLException
    {
        ...
        try
        {
            ...
            if (colonPos != -1)
            {
                ...
                {        // Tolerate an empty port part (e.g. http://mucommander.com:/)
                    try
                    {
...
<<< This is the complex bug 'keen_swartz' (instance 7 of 9) >>>
<<< This is the complex bug 'keen_swartz' (instance 8 of 9) >>>
<<< This is the complex bug 'keen_swartz' (instance 9 of 9) >>>
