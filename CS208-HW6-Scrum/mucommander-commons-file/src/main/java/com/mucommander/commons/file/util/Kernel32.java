...
public class Kernel32
{
    ...
    static
    {
        ...
        {        // Don't even bother if we're not running Windows
<<< This is the medium bug 'vibrant_rubin' (instance 1 of 4) >>>
<<< This is the medium bug 'vibrant_rubin' (instance 2 of 4) >>>
            try
            {
