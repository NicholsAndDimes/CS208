...
public class AuthException extends IOException
{
    ...
    public AuthException(FileURL fileURL, String msg)
    {
        ...
        if (msg != null)
<<< This is the complex bug 'expressive_chatterjee' (instance 7 of 9) >>>
<<< This is the complex bug 'expressive_chatterjee' (instance 8 of 9) >>>
<<< This is the complex bug 'expressive_chatterjee' (instance 9 of 9) >>>
        {
            this.msg = msg.trim();
        }
    }
