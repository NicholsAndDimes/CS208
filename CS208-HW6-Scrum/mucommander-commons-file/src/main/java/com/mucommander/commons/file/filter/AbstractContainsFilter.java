...
public class AbstractContainsFilter extends AbstractStringCriterionFilter
{
    ...
    {
<<< This is the complex bug 'hungry_tereshkova' (instance 1 of 9) >>>
<<< This is the complex bug 'hungry_tereshkova' (instance 2 of 9) >>>
<<< This is the complex bug 'hungry_tereshkova' (instance 3 of 9) >>>
        if (isCaseSensitive())
        {
