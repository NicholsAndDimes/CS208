...
<<< This is the complex bug 'hungry_tereshkova' (instance 4 of 9) >>>
<<< This is the complex bug 'hungry_tereshkova' (instance 5 of 9) >>>
<<< This is the complex bug 'hungry_tereshkova' (instance 6 of 9) >>>
        {
            value = values[i];
            if (accept(value))
            {
