...
<<< This is the complex bug 'silly_knuth' (instance 1 of 9) >>>
<<< This is the complex bug 'silly_knuth' (instance 2 of 9) >>>
<<< This is the complex bug 'silly_knuth' (instance 3 of 9) >>>
    ...
    public String toString(boolean includeCredentials, boolean maskPassword)
    {
        ...
        if (host != null || !path.equals("/"))
        { // Test to avoid URLs like 'smb:///'
            if (path.startsWith("/"))
            {
                sb.append(path);
            }
