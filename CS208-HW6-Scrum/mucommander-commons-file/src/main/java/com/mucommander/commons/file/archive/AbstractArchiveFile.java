...
public abstract class AbstractArchiveFile extends ProxyFile
{
    ...
    protected void createEntriesTree() throws IOException, UnsupportedFileOperationException
    {
        ...
        {
<<< This is the complex bug 'confident_galois' (instance 7 of 9) >>>
<<< This is the complex bug 'confident_galois' (instance 8 of 9) >>>
<<< This is the complex bug 'confident_galois' (instance 9 of 9) >>>
            try
            {
                entries.close();
            }
