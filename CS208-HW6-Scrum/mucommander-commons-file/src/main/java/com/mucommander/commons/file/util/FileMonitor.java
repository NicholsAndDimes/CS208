    ...
    public synchronized void startMonitoring()
    {
        if (monitorThread == null)
        {
            ...
            while (!isInitialized)
            {
                ...
                {
<<< This is the complex bug 'nervous_matsumoto' (instance 7 of 9) >>>
<<< This is the complex bug 'nervous_matsumoto' (instance 8 of 9) >>>
<<< This is the complex bug 'nervous_matsumoto' (instance 9 of 9) >>>
                }
            }
        }
    }
