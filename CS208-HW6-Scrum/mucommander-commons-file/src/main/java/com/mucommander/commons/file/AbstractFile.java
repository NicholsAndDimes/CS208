...
<<< This is the complex bug 'expressive_chatterjee' (instance 1 of 9) >>>
<<< This is the complex bug 'expressive_chatterjee' (instance 2 of 9) >>>
<<< This is the complex bug 'expressive_chatterjee' (instance 3 of 9) >>>
...
public abstract class AbstractFile implements FileAttributes
{
    ...
    public final AbstractArchiveFile getParentArchive()
    {
        ...
        {
            if (hasAncestor(AbstractArchiveEntryFile.class))
            {
