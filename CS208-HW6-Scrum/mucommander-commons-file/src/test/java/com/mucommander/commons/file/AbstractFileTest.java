...
<<< This is the medium bug 'zen_franklin' (instance 3 of 4) >>>
<<< This is the medium bug 'zen_franklin' (instance 4 of 4) >>>
import java.net.URL;
...
public abstract class AbstractFileTest
{
    ...
    protected void testCopyTo(boolean useRemoteCopy) throws IOException, NoSuchAlgorithmException
    {
        ...
        if (success)
        {     // If copyTo/copyRemotelyTo succeeded
