...
public class AssociationReader extends DefaultHandler implements AssociationsXmlConstants
{
    ...
    public static void read(InputStream in, AssociationBuilder b) throws IOException, CommandException
    {
        ...
        {
<<< This is the medium bug 'vibrant_cerf' (instance 1 of 4) >>>
<<< This is the medium bug 'vibrant_cerf' (instance 2 of 4) >>>
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    if (qName.equals(ELEMENT_IS_HIDDEN))
                    {
                        if ((buffer = attributes.getValue(ATTRIBUTE_VALUE)) == null)
                        {
                            return;
                    ...
                    {
                        if (qName.equals(ELEMENT_IS_SYMLINK))
                        {
                            if ((buffer = attributes.getValue(ATTRIBUTE_VALUE)) == null)
                            {
                                return;
                        ...
                        {
                            if (qName.equals(ELEMENT_IS_READABLE))
                            {
                                if ((buffer = attributes.getValue(ATTRIBUTE_VALUE)) == null)
                                {
                                    return;
                            ...
                            {
                                if (qName.equals(ELEMENT_IS_WRITABLE))
                                {
                                    if ((buffer = attributes.getValue(ATTRIBUTE_VALUE)) == null)
                                    {
                                        return;
                                ...
                                {
                                    if (qName.equals(ELEMENT_IS_EXECUTABLE))
                                    {
                                        if ((buffer = attributes.getValue(ATTRIBUTE_VALUE)) == null)
                                        {
                                            return;
