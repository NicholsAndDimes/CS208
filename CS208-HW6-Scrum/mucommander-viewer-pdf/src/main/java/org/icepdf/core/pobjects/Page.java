...
public class Page extends Dictionary
{
        ...
        if (annots != null && annots instanceof List)
        {
            ...
            for (int i = 0; i < v.size(); i++)
            {
                ...
                else
                {
                    ...
                    { // HashMap lacks "Type"->"Annot" entry
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (totalRotation > 90 && totalRotation < 180)
                            {
                            ...
                            {
                                if (totalRotation > 180 && totalRotation < 270)
                                {
                                ...
                                {
                                    if (totalRotation > 270 && totalRotation < 360)
                                    {
    ...
    public PRectangle getPageBoundary(final int specifiedBox)
    {
        ...
        {
            if (specifiedBox == BOUNDARY_CROPBOX)
            {
            ...
            {
                if (specifiedBox == BOUNDARY_BLEEDBOX)
                {
                ...
                {
                    if (specifiedBox == BOUNDARY_TRIMBOX)
                    {
                    ...
                    {
                        if (specifiedBox == BOUNDARY_ARTBOX)
                        {
