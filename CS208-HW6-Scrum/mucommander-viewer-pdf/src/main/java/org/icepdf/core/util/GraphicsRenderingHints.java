...
public class GraphicsRenderingHints
{
    ...
    private void setFromProperties()
    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_ALPHA_INTERPOLATION_DEFAULT"))
                {
                    screenAlphaInterpolocation = RenderingHints.VALUE_ALPHA_INTERPOLATION_DEFAULT;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_ALPHA_INTERPOLATION_SPEED"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_ANTIALIAS_ON"))
                {
                    screenAntiAliasing = RenderingHints.VALUE_ANTIALIAS_ON;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_ANTIALIAS_OFF"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_TEXT_ANTIALIAS_ON"))
                {
                    screenTextAntiAliasing = RenderingHints.VALUE_TEXT_ANTIALIAS_ON;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_TEXT_ANTIALIAS_OFF"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_COLOR_RENDER_QUALITY"))
                {
                    screenColorRendering = RenderingHints.VALUE_COLOR_RENDER_QUALITY;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_COLOR_RENDER_SPEED"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_DITHER_DISABLE"))
                {
                    screenDithering = RenderingHints.VALUE_DITHER_DISABLE;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_DITHER_ENABLE"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_FRACTIONALMETRICS_ON"))
                {
                    screenFractionalMetrics = RenderingHints.VALUE_FRACTIONALMETRICS_ON;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_FRACTIONALMETRICS_OFF"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_INTERPOLATION_BILINEAR"))
                {
                    screenInterPolation = RenderingHints.VALUE_INTERPOLATION_BILINEAR;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_INTERPOLATION_NEAREST_NEIGHBOR"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_RENDER_QUALITY"))
                {
                    screenRendering = RenderingHints.VALUE_RENDER_QUALITY;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_RENDER_SPEED"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_STROKE_NORMALIZE"))
                {
                    screenStrokeControl = RenderingHints.VALUE_STROKE_NORMALIZE;
                }
                else
                {
                    if (property.equalsIgnoreCase("VALUE_STROKE_PURE"))
                    {
        ...
        if (property != null)
        {
            ...
            {
                if (property.equalsIgnoreCase("VALUE_DRAW_NO_BACKGROUND"))
                {
