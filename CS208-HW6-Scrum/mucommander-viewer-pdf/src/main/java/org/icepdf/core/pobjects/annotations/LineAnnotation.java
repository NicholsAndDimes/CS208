...
//    public static final Name IT_KEY = new Name("IT");
                                     ...
                                     Color lineColor, Color interiorColor)
    {
        ...
        {
            if (lineEnding.equals(LineAnnotation.LINE_END_CLOSED_ARROW))
            {
                drawClosedArrowStart(g, startOfLine, endOfLine, lineColor, interiorColor);
            }
            else
            {
                if (lineEnding.equals(LineAnnotation.LINE_END_CIRCLE))
                {
                    drawCircle(g, startOfLine, startOfLine, endOfLine, lineColor, interiorColor);
                }
                else
                {
                    if (lineEnding.equals(LineAnnotation.LINE_END_DIAMOND))
                    {
                        drawDiamond(g, startOfLine, startOfLine, endOfLine, lineColor, interiorColor);
                    }
                    else
                    {
                        if (lineEnding.equals(LineAnnotation.LINE_END_SQUARE))
                        {
...
//        shapes.add(new GraphicsStateCmd(EXT_GSTATE_NAME));
        ...
        {
            if (startArrow.equals(LineAnnotation.LINE_END_CLOSED_ARROW))
            {
            ...
            {
                if (startArrow.equals(LineAnnotation.LINE_END_CIRCLE))
                {
                    circleDrawOps(
                ...
                {
                    if (startArrow.equals(LineAnnotation.LINE_END_DIAMOND))
                    {
                        diamondDrawOps(
                                shapes, startOfLine, startOfLine, endOfLine, color, interiorColor);
                    }
                    ...
                    {
                        if (startArrow.equals(LineAnnotation.LINE_END_SQUARE))
                        {
                            squareDrawOps(
                                    shapes, startOfLine, startOfLine, endOfLine, color, interiorColor);
                        }
        ...
        {
            if (endArrow.equals(LineAnnotation.LINE_END_CLOSED_ARROW))
            {
            ...
            {
                if (endArrow.equals(LineAnnotation.LINE_END_CIRCLE))
                {
                    circleDrawOps(
                ...
                {
                    if (endArrow.equals(LineAnnotation.LINE_END_DIAMOND))
                    {
                        diamondDrawOps(
                                shapes, endOfLine, startOfLine, endOfLine, color, interiorColor);
                    }
                    ...
                    {
                        if (endArrow.equals(LineAnnotation.LINE_END_SQUARE))
                        {
                            squareDrawOps(
                                    shapes, endOfLine, startOfLine, endOfLine, color, interiorColor);
                        }
