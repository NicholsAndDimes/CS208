...
public class Destination
{
    ...
    private void init()
    {
        ...
        {
            if (object instanceof Name || object instanceof StringObject)
            {
                String s;
