            ...
            if (image != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if ((width >= 1000 || height >= 1000) && (width < 1500 || height < 1500))
                            {
                                imageScale = 0.70;
                            }
                            else
                            {
                                if ((width >= 1500 || height >= 1500) && (width < 2000 || height < 2000))
                                {
                                    imageScale = 0.60;
                                }
                                else
                                {
                                    if ((width >= 2000 || height >= 2000) && (width < 2500 || height < 2500))
                                    {
                                        imageScale = 0.50;
                                    }
                                    else
                                    {
                                        if ((width >= 2500 || height >= 2500) && (width < 3000 || height < 3000))
                                        {
                                            imageScale = 0.40;
                                        }
                                        else
