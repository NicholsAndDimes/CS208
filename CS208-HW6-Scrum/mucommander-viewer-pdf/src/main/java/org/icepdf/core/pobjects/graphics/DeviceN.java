...
public class DeviceN extends PColorSpace
{
    ...
    DeviceN(Library l, HashMap h, Object o1, Object o2, Object o3, Object o4)
    {
        ...
        for (Name name : names)
        {
            ...
            {
                if (name.getName().toLowerCase().startsWith("m"))
                {
                    cmykCount++;
                }
                else
                {
                    if (name.getName().toLowerCase().startsWith("y"))
                    {
                        cmykCount++;
                    }
                    else
                    {
                        if (name.getName().toLowerCase().startsWith("k"))
                        {
                            cmykCount++;
                        }
                        else
                        {
                            if (name.getName().toLowerCase().startsWith("b"))
                            {
                                cmykCount++;
                            }
                        }
