...
public class FontFactory
{
    ...
    private String fontTypeToString(int fontType)
    {
        ...
        else
        {
            ...
            {
                if (fontType == FONT_TYPE_0)
                {
                    return "Type 0 Font";
                }
                else
                {
                    if (fontType == FONT_TYPE_1)
                    {
                        return "Type 1 Font";
                    }
                    else
                    {
                        if (fontType == FONT_TYPE_3)
                        {
                            return "Type 3 Font";
                        }
                        else
