...
//                    logger.warning("IO reading error.");
                ...
                else
                {
                    ...
                    {
                        if (nextToken.equals("endobj") || nextToken.equals("endobject")
...
//                        return null;
                            ...
                            else
                            {
                                if (nextToken.equals("stream"))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        { // reader is just regular InputStream (BufferedInputStream)
                                    ...
                                    if (type != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if (type.equals("XObject") && subtype.equals("Image"))
                                                {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            if (n.equals(FontDescriptor.TYPE))
                                                                                            {
                                                                                                stack.push(new FontDescriptor(library, hashMap));
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                if (n.equals(CMap.TYPE))
                                                                                                {
                                                                                                    stack.push(hashMap);
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    ...
                                                                                                    {
                                                                                                        if (n.equals(OptionalContentGroup.TYPE))
                                                                                                        {
                                                                                                            stack.push(new OptionalContentGroup(library, hashMap));
                                                                                                        }
                                                                                                        else
                                                                                                        {
                                                                                                            if (n.equals(OptionalContentMembership.TYPE))
                                                                                                            {
    ...
    public boolean readLineForInlineImage(OutputStream out) throws IOException
    {
        ...
        while (true)
        {
            ...
            {
                if (state == STATE_PRE_I && c == 'I')
                {
                    state++;
                }
                else
                {
                    if (state == STATE_PRE_WHITESPACE && isWhitespace((char) (0xFF & c)))
                    {
