            ...
            float[] decode)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    if (jpegEncoding == ImageUtility.JPEG_ENC_YCbCr && bitspercomponent == 8 &&
                    ...
                    {
                        if (jpegEncoding == ImageUtility.JPEG_ENC_YCCK && bitspercomponent == 8)
                        {
                        ...
                        {
                            if (jpegEncoding == ImageUtility.JPEG_ENC_GRAY && bitspercomponent == 8)
                            {
