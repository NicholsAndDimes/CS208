        ...
        if (o != null)
        {
            ...
            else
            {
                if (o instanceof Name)
                {
                    ...
                    {
                        if (o.equals(DeviceRGB.DEVICERGB_KEY) ||
                        ...
                        {
                            if (o.equals(DeviceCMYK.DEVICECMYK_KEY) ||
                            ...
                            {
                                if (o.equals(PatternColor.PATTERN_KEY))
                                {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            if (colorant.equals(DeviceN.DEVICEN_KEY))
                                            {
                                            ...
                                            {
                                                if (colorant.equals(ICCBased.ICCBASED_KEY))
                                                {
                                                    colorSpace = library.getICCBased((Reference) v.get(1));
                                                }
                                                else
                                                {
                                                    if (colorant.equals(DeviceRGB.DEVICERGB_KEY))
                                                    {
                                                        colorSpace = new DeviceRGB(library, null);
                                                    }
                                                    else
                                                    {
                                                        if (colorant.equals(DeviceCMYK.DEVICECMYK_KEY))
                                                        {
                                                            colorSpace = new DeviceCMYK(library, null);
                                                        }
                                                        else
                                                        {
                                                            if (colorant.equals(DeviceGray.DEVICEGRAY_KEY))
                                                            {
                                                                colorSpace = new DeviceGray(library, null);
                                                            }
                                                            else
                                                            {
                                                                if (colorant.equals(PatternColor.PATTERN_KEY))
                                                                {
