        ...
        if (annotation instanceof LinkAnnotation)
        {
            ...
            if (action != null)
            {
                ...
                else
                {
                    ...
                    {
                        if (action instanceof GoToRAction)
                        {
            ...
            {
                if (linkAnnotation.getDestination() != null &&
                        documentViewController != null)
                {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if (action instanceof NamedAction)
                                    {
                                        ...
                                        {
                                            if (NamedAction.LAST_PAGE_KEY.equals(actionName))
                                            {
                                            ...
                                            {
                                                if (NamedAction.NEXT_PAGE_KEY.equals(actionName))
                                                {
                                                ...
                                                {
                                                    if (NamedAction.PREV_PAGE_KEY.equals(actionName))
                                                    {
                                                        int currentPageNumber = documentViewController.getCurrentPageIndex();
                                                        documentViewController.setCurrentPageIndex(currentPageNumber - 1);
                                                    ...
                                                    {
                                                        if (NamedAction.PRINT_KEY.equals(actionName))
                                                        {
                                                        ...
                                                        {
                                                            if (NamedAction.SAVE_AS_KEY.equals(actionName))
                                                            {
                                                                SwingController controller = (SwingController) documentViewController.getParentController();
                                                                controller.saveFile();
                                                            }
