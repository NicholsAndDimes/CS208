        ...
        implements PageViewComponent
{
    ...
    public void updateView(String propertyConstant, Object oldValue, Object newValue)
    {
        ...
        {
            if (PropertyConstants.DOCUMENT_VIEW_ZOOM_CHANGE.equals(propertyConstant))
            {
                pageZoom = (Float) newValue;
            }
            else
            {
                if (PropertyConstants.DOCUMENT_VIEW_REFRESH_CHANGE.equals(propertyConstant))
                {
                    // nothing to do but repaint
                }
                else
                {
                    if (PropertyConstants.DOCUMENT_VIEW_DEMO_MODE_CHANGE.equals(propertyConstant))
                    {
    ...
    public class PageImageCaptureTask implements Callable<Object>, PaintPageListener
    {
        ...
        public Object call() throws Exception
        {
            ...
            catch (InterruptedException e)
            {
                ...
                if (isFirstProgressivePaint)
                {
                    pageBufferStore.setImageReference(null);
                }
            }
            catch (Throwable e)
            {
