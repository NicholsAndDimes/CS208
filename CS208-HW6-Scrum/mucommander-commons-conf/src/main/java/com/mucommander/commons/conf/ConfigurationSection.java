...
class ConfigurationSection
{
    ...
    public boolean removeSection(ConfigurationSection section)
    {
        ...
        while (sectionNames.hasNext())
        {
            ...
            {
<<< This is the complex bug 'recursing_murdock' (instance 1 of 9) >>>
<<< This is the complex bug 'recursing_murdock' (instance 2 of 9) >>>
<<< This is the complex bug 'recursing_murdock' (instance 3 of 9) >>>
                removeSection(name);
                return true;
            }
        }
