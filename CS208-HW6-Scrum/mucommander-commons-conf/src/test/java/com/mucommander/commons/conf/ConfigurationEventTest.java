...
public class ConfigurationEventTest
{
    ...
    {
        for (int i = 0; i < 7; i++)
<<< This is the complex bug 'sleepy_noether' (instance 1 of 9) >>>
<<< This is the complex bug 'sleepy_noether' (instance 2 of 9) >>>
<<< This is the complex bug 'sleepy_noether' (instance 3 of 9) >>>
        {
