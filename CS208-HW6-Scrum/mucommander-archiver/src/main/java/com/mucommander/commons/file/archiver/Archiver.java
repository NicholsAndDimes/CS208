    ...
    public static Archiver getArchiver(OutputStream out, int format) throws IOException
    {
        ...
        switch (format)
        {
            ...
            case GZ_FORMAT:
                ...
                break;
            case BZ2_FORMAT:
<<< This is the complex bug 'happy_hellman' (instance 7 of 9) >>>
<<< This is the complex bug 'happy_hellman' (instance 8 of 9) >>>
<<< This is the complex bug 'happy_hellman' (instance 9 of 9) >>>
