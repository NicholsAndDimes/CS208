...
public final class StringUtils
{
    ...
    public static boolean matchesIgnoreCase(String a, char[] b, int posA)
    {
        ...
        while (posB > 0)
        {
            ...
            {
<<< This is the complex bug 'romantic_rhodes' (instance 7 of 9) >>>
<<< This is the complex bug 'romantic_rhodes' (instance 8 of 9) >>>
<<< This is the complex bug 'romantic_rhodes' (instance 9 of 9) >>>
                cB = Character.toLowerCase(cB);
            }
            if (cA != cB)
            {
