...
public class Main
{
    ...
    private static void menuAddStudentToClass() {
        ...
        int classId = 0;
        try {
            System.out.println("Enter the existing student id you want to enroll in a class: ");
            id = Integer.parseInt(inputScanner.nextLine());
        } catch (Exception e) {
            System.out.println("Invalid input, please try again.");
            return;
        ...
        database.enrollStudentInClass(id, classId);
    }
    ...
    private static void menuDropStudentFromClass()
    {
        ...
        int classId = 0;
        try {
            System.out.println("Enter the existing student id you want to drop from a class: ");
            id = Integer.parseInt(inputScanner.nextLine());
        } catch (Exception e) {
            System.out.println("Invalid input, please try again.");
            return;
        ...
        try {
            System.out.println("Enter the class id you want to drop: ");
            classId = Integer.parseInt(inputScanner.nextLine());
        } catch (Exception e) {
            System.out.println("Invalid input, please try again.");
            return;
        }
        database.dropStudentFromClass(id, classId);
    }
}
